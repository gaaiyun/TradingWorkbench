...
def get_instrument_context_from_state(state: Mapping[str, Any]) -> str:
    ...
    if isinstance(packet, Mapping):
        ...
        result += (
            ...
            "already appears in a cited ledger row. A disclaimer such as "
            "'estimated', 'approximately', or 'calculated here' does not make "
            "an unlisted ratio or percentage publishable; express the point "
            "qualitatively without a number instead. A single indicator snapshot "
