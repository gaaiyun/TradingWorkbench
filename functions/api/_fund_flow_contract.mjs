...
export const SHENZHEN_SNAPSHOT_SHARE_SYMBOLS = Object.freeze([
  "159995.SZ",
]);
...
const SNAPSHOT_SHARE_SYMBOL_SET = new Set(SHENZHEN_SNAPSHOT_SHARE_SYMBOLS);
const ETF_SYMBOL_SET = new Set([
  ...SHANGHAI_DERIVED_SHARE_SYMBOLS,
  ...SHENZHEN_SNAPSHOT_SHARE_SYMBOLS,
]);
